 ...
 */
class ChatContact extends User
{
    /**
     * @var array
     */
     ...
     */
    public static function find(): ChatContactQuery
    {
        return new ChatContactQuery(get_called_class());
    }
    ...
    public function fields(): array
    {
        return [
            ...
            'uid' => function (ChatContact $model) {
            ...
            'contact' => function (ChatContact $model) {
                return [
                    'id' => $model->id,
